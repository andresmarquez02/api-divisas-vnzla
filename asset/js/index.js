let button_divisa = document.querySelectorAll("#button_divisa");

let response = "No se ha seleccionado una divisa";
    ...
    e.addEventListener("click", () => {
        res.innerHTML = `
            <div class="flex justify-center">
                <svg role="status" class="w-8 h-8 mr-2 text-gray-200 text-center animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="text-xl text-gray-400 font-bold dark:text-gray-300">
                    Cargando
                </div>
            </div>
        `;
